...
<script>
			...
			function printDiv(id)
			{
			  ...
			  newWin.document.write("<h4 style='margin-top:-38px; text-align:center'>LISTA DE CARGOS</h4>");
		  ...
		  $.ajax({
			...
			<script>
			 ...
			 location.href="/sisGab/nomeacao/deletar/"+id }
				...
				<br>
				<table id="listarCargos" class="table table-striped table-hover example">
					<thead>
						<tr>
							...
							<th style="text-align: left; padding-left: 10px;">Tipo Cargo</th>							
							<th style="text-align: left; padding-left: 10px;">Quantidade</th>
							<th style="text-align: left; padding-left: 10px;">Disponível</th>
					...
					<tbody>
						...
						<g:each status="i2" in='${secretariaCargo?}' var="it">
							<tr class='linha_registro'>
								...
								<td>
									  ${ it.quantidade - qtdcargosDisponivel[i2]} 
								</td>
									...
									<div class="opcoes">
										<div style="display: inline">
											...
											<div class="btn btn-success btn-xs btn-flat"><a
												...
												href="/sisGab/secretariaCargo/info/${it.id}"><span
			...
			<button class="btn btn-danger btn-flat" onClick="printDiv('listarCargos')">
						...
						<div class="modal-body">
							<g:form controller="nomeacao" action="salvar" class="form">
								...
								<div class="modal-footer">
									...
									<input type="reset" class="btn btn btn-flat" value="Imprimir">
								</div>
									</fieldset>
